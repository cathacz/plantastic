    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.wrapper}>
          ...
          <Text style={styles.h3}>Angaben gem. § 5 TMG:</Text>
          <Text style={styles.p}>
            Vorname {"\n"}Name {"\n"}Adresse {"\n"}PLZ{" "}
          </Text>
          <Text style={styles.h3}>Kontaktaufnahme:</Text>
          <Text style={styles.p}>
            Telefon:{"\n"}Fax: {"\n"}E-Mail:
          </Text>
          <Text style={styles.h2}>Umsatzsteuer-ID</Text>
          <Text style={styles.h3}>
            Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:
          </Text>
          <Text style={styles.p}> DE XXX XXX XXX</Text>
          <Text style={styles.h2}>Haftungsausschluss – Disclaimer: </Text>
          <Text style={styles.p}>
            Haftung für Inhalte Alle Inhalte unseres Internetauftritts wurden
            mit größter Sorgfalt und nach bestem Gewissen erstellt. Für die
            ...
            möglich. Bei Bekanntwerden von den o.g. Rechtsverletzungen werden
            wir diese Inhalte unverzüglich entfernen.
          </Text>
          <Text style={styles.h3}>Haftungsbeschränkung für externe Links</Text>
          <Text style={styles.p}>
            ...
            zum Zeitpunkt der Linksetzung auf eventuelle Rechtsverstöße
            ...
            lediglich verweist. {"\n"}Werden uns Rechtsverletzungen bekannt,
            werden die externen Links durch uns unverzüglich entfernt.
          </Text>
          <Text style={styles.h3}>Urheberrecht</Text>
          <Text style={styles.p}>
